      ...
      <form action="loginproc.php" method="post" >
        <div class="list-group">
          <div class="list-group-item">
            <input type="text" placeholder="Username" class="form-control no-border" name="username" value="adminadmin" required>
          </div>
          <div class="list-group-item">
            <input type="password" placeholder="Password" class="form-control no-border" name="password" value="123123123" required>
          </div>
        </div>
...
<footer id="footer">
  <div class="text-center padder">
    <p> <small>SKYEY's Multi Level Marketing Script &#174;<br>&copy; 2014</small> </p>
  </div>
</footer>
<!-- / footer -->
<!-- Bootstrap -->
